...
import com.dragonlicat.spring.kafka.demo.config.SpringProducerConfig;
...
public class ProducerServiceImpl implements ProducerService {
	...
	@Autowired
	private KafkaTemplate<Object, GenericRecord> kafkaTemplate;
	...
	public void sendMsg() {
		...
		ProducerRecord<Object, GenericRecord> record = new ProducerRecord<>(topic, convertAvro(schema));
